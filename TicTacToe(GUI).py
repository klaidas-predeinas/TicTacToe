...
def tictac():
    ...
    def draw():
        if num1 != True and num2 != True and num3 != True and num4 != True and num5 != True and num6 != True and num7 != True and num8 != True and num9 != True and check() == None:
            tkinter.messagebox.showinfo("Draw - TicTacToe", 'The game was a draw()')
            master.destroy()
        elif check() != None:
...
while cont != 'n':
    cont = input('do you want to play tictactoe(y/n)?: ').lower()
